...
class QAOASolver:
    ...
    def __init__(
        ...
        *,
        ...
        self.opt_cfg = opt_cfg or OptimizerOptions(name="spsa", options={"maxiter": 100, "a": 0.2, "c": 0.2})
    ...
    def run(
        ...
        *,
        ...
        res = self.minimizer.minimize(
            theta0,
            optimizer=optimizer,
            need_transpile=self.qaoa_cfg.need_transpile if need_transpile is None else need_transpile,
