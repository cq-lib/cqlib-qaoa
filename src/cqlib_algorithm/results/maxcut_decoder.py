...
def best_bitstring_from_probability(prob: Dict[str, float] | str, ising: IsingHamiltonian) -> str:
...
def decode_from_platform_result(result: Dict, n: int, *, choose_ones: bool = True, ising: IsingHamiltonian) -> Tuple[str, str, List[int]]:
...
def plot_maxcut_solution(
    ...
    *,
    ...
    """
    best_raw, _, part = decode_from_platform_result(result, n=n, choose_ones=choose_ones, ising=ising)
