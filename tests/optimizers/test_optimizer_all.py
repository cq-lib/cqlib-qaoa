...
# Import targets
# ---------------------------------------------------------------------
MODULE_SPSA = "cqlib_qaoa.optimizers.spsa"
MODULE_COBY = "cqlib_qaoa.optimizers.cobyla"
MODULE_NM = "cqlib_qaoa.optimizers.nelder_mead"
MODULE_OPTS = "cqlib_qaoa.optimizers.options"
