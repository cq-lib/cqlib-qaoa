...
def main():
    ...
    # 5) Select optimizer
    # SPSA
    #opt_cfg = OptimizerOptions(name="spsa", options={"maxiter": 2000, "a": 0.2, "c": 0.2})
    # COBYLA
    #opt_cfg = OptimizerOptions(name="cobyla",options={"maxiter": 2000})
    # Nelder-Mead
    opt_cfg = OptimizerOptions(name="nelder_mead",options={"maxiter": 1000})
